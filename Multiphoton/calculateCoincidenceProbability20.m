function prob = calculateCoincidenceProbability20(amplitudeMatrix,phaseMatrix,freq,phiv1,phiv2,fv1,fv2,modeMatch,tauvals)
% inputs:
...
background = abs(amplitudeMatrix(1,1)*amplitudeMatrix(1,2))^2/2*integral2(ampfun,freq(1),freq(end),freq(1),freq(end));
