%% SIMULATION-NO-CALIBRATION-NON-GAUSSIAN-FILTER-FILTER-NON-GAUSSIAN-FIT Simulation of characterization procedure
...
% These filter functions are used to simulate the experimental data and to
% perform curve-fitting on the simulated data.
...
for msize = msizeVec
    ...
    for clicks = clickVec
        ...
        for Counter1=1:nSimulations
            ...
            % Artificially set modeMatchEstimated to unity. Equivalent to
            ...
            drawnow            
            print([pwd,'/Datasets/NoCalibration/Delta_',num2str(msize),'Channel'...
                ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
                ,'.png'],'-dpng');
            
            % The following code writes the matrices to csv files in the
            % folder DataSets
            csvwrite([pwd,'/Datasets/NoCalibration/U_',num2str(msize),'Channel'...
                ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
                ,'.csv'],interferometerMatrixClean);
            csvwrite([pwd,'/Datasets/NoCalibration/V_',num2str(msize),'Channel'...
                ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
                ,'.csv'],TransitionMatrix);
            csvwrite([pwd,'/Datasets/NoCalibration/Delta_',num2str(msize),'Channel'...
                ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
                ,'.csv'],delta);
        end 
    end
