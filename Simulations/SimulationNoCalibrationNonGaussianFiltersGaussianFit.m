%% SIMULATION-NO-CALIBRATION-NON-GAUSSIAN-FILTER-FILTER-GAUSSIAN-FIT 
% Simulation of characterization procedure
...
for msize = msizeVec
    ...
    for clicks = clickVec
        ...
        for Counter1=1:nSimulations
            ...
            drawnow            
            print([pwd,'/Datasets/NoCalibrationGaussian/Delta_',num2str(msize),'Channel'...
                ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
                ,'.png'],'-dpng');
            
            % The following code writes the matrices to csv files in the
            % folder DataSets
            csvwrite([pwd,'/Datasets/NoCalibrationGaussian/U_',num2str(msize),'Channel'...
                ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
                ,'.csv'],interferometerMatrixClean);
            csvwrite([pwd,'/Datasets/NoCalibrationGaussian/V_',num2str(msize),'Channel'...
                ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
                ,'.csv'],TransitionMatrix);
            csvwrite([pwd,'/Datasets/NoCalibrationGaussian/Delta_',num2str(msize),'Channel'...
                ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
                ,'.csv'],delta);
        end 
    end
