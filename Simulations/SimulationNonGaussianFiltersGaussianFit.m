...
p = 500; % number of readings of the filter
...
%             drawnow  
%             print([pwd,'/Datasets/Gaussian/Delta_',num2str(msize),'Channel'...
%                 ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
%                 ,'.png'],'-dpng');
%             
%             % The following code writes the matrices to csv files in the
%             % folder DataSets
%             csvwrite([pwd,'/Datasets/Gaussian/U_',num2str(msize),'Channel'...
%                 ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
%                 ,'.csv'],interferometerMatrixClean);
%             csvwrite([pwd,'/Datasets/Gaussian/V_',num2str(msize),'Channel'...
%                 ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
%                 ,'.csv'],TransitionMatrix);
%             csvwrite([pwd,'/Datasets/Gaussian/Delta_',num2str(msize),'Channel'...
%                 ,num2str(log10(clicks)),'e10Photons',num2str(Counter1)...
%                 ,'.csv'],delta);
        end 
    end
...
csvwrite([pwd,'/Datasets/Gaussian/Inaccuracy.csv'],Inaccuracy);